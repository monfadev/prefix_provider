...
///
abstract class PrefixProvider {
  /// LIST OF OPERATOR WITH DATA
  static List<Operator> data = [
    Operator(name: "telkomsel", value: [
      "0812",
      "0813",
      "0821",
      "0822",
    ...
    Operator(
        name: "xl", value: ["0817", "0818", "0819", "0859", "0877", "0878"]),
...
String? parseOperator(int? phone) {
  if (phone == null) {
    ...
    for (Operator item in PrefixProvider.data) {
